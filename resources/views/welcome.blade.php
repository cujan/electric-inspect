...
<head>
    ...
    <title>Electric Inspect - Professional Electrical Inspection Management</title>
</head>
<body class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
            <div class="text-center">
                ...
                <h1 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 dark:text-white mb-6">
                    ...
                    <span class="text-blue-600 dark:text-blue-400">Inspection Management</span>
                </h1>

                <p class="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto">
                    Streamline your electrical inspection workflow with our comprehensive management system. Track equipment, manage inspections, and generate professional reports with ease.
                </p>
    ...
    <div class="bg-white dark:bg-gray-900 py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">Everything You Need</h2>
                <p class="text-lg text-gray-600 dark:text-gray-400">Powerful features to manage your electrical inspections efficiently</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 hover:shadow-lg transition">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Customer Management</h3>
                    <p class="text-gray-600 dark:text-gray-400">Organize and track all your customers with detailed information and contact history.</p>
                </div>
                ...
                <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 hover:shadow-lg transition">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Equipment Tracking</h3>
                    <p class="text-gray-600 dark:text-gray-400">Monitor all electrical equipment with serial numbers, locations, and maintenance history.</p>
                </div>
                ...
                <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 hover:shadow-lg transition">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Inspection Records</h3>
                    <p class="text-gray-600 dark:text-gray-400">Create, manage, and track inspections with detailed results and file attachments.</p>
                </div>
                ...
                <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 hover:shadow-lg transition">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">PDF Reports</h3>
                    <p class="text-gray-600 dark:text-gray-400">Generate professional inspection reports with your organization's logo and branding.</p>
                </div>
                ...
                <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 hover:shadow-lg transition">
                    ...
                    <p class="text-gray-600 dark:text-gray-400">Assign inspections to technicians and track their work progress in real-time.</p>
                </div>
                ...
                <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 hover:shadow-lg transition">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Multi-Organization</h3>
                    <p class="text-gray-600 dark:text-gray-400">Support for multiple organizations with complete data isolation and security.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-blue-600 dark:bg-blue-700 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-xl text-blue-100 mb-8">Sign in to streamline your electrical inspection workflow.</p>
            @guest
